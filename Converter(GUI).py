...
# Define colors
primaryColor = "#3F3D56"
secondaryColor = "#F9794A"
primShade = "#6F6D86"
secondaryShade = "#FFB99F"

# Define fonts
def getFont(size=10, bold=False):
...
# Degree Label
degLabel = tk.Label(leftFrame, text="Degree", bg=primaryColor, fg=secondaryColor, font=getFont(10))
...
convertToMenu.place(x=30, y=320, width=340, height=42)
...
resultLabel = tk.Label(rightFrame, textvariable=resultVar, bg=secondaryColor, fg=primaryColor, font=getFont(32, True))
